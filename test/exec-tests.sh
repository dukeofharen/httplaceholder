...
dotnet run --project $HTTPL_ROOT_DIR --useInMemoryStorage --storeResponses --enableReverseProxy > $DIR/logs/httplaceholder-in-memory.txt 2>&1 &
sleep 5
...
dotnet run --project $HTTPL_ROOT_DIR --fileStorageLocation $FILE_STORAGE_PATH  --storeResponses --enableReverseProxy > $DIR/logs/httplaceholder-file-storage.txt 2>&1 &
sleep 5
...
dotnet run --project $HTTPL_ROOT_DIR --sqliteConnectionString "Data Source=$SQLITE_PATH;Foreign Keys=True" --storeResponses --enableReverseProxy > $DIR/logs/httplaceholder-sqlite.txt 2>&1 &
sleep 5
...
dotnet run --project $HTTPL_ROOT_DIR --mysqlConnectionString "Server=localhost;Database=httplaceholder;Uid=root;Pwd=root;Allow User Variables=true;SSL Mode=None" --storeResponses --enableReverseProxy > $DIR/logs/httplaceholder-mysql5.txt 2>&1 &
sleep 5
...
dotnet run --project $HTTPL_ROOT_DIR --mysqlConnectionString "Server=localhost;Port=3307;Database=httplaceholder;Uid=root;Pwd=root;Allow User Variables=true" --storeResponses --enableReverseProxy > $DIR/logs/httplaceholder-mysql8.txt 2>&1 &
sleep 5
...
dotnet run --project $HTTPL_ROOT_DIR --mysqlConnectionString "Server=localhost;Port=3308;Database=httplaceholder;Uid=root;Pwd=root;Allow User Variables=true" --storeResponses --enableReverseProxy > $DIR/logs/httplaceholder-mariadb.txt 2>&1 &
sleep 5
...
dotnet run --project $HTTPL_ROOT_DIR --sqlServerConnectionString "Server=localhost,1433;Database=httplaceholder;User Id=sa;Password=Password123!" --storeResponses --enableReverseProxy > $DIR/logs/httplaceholder-mssql.txt 2>&1 &
sleep 5
...
dotnet run --project $HTTPL_ROOT_DIR --postgresConnectionString "Host=localhost,5432;Username=postgres;Password=postgres;Database=httplaceholder;SearchPath=public" --storeResponses --enableReverseProxy > $DIR/logs/httplaceholder-postgres.txt 2>&1 &
sleep 5
