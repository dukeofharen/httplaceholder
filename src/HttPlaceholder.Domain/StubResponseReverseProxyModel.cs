...
namespace HttPlaceholder.Domain
{
    ...
    /// </summary>
    public class StubResponseReverseProxyModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets whether the query string of the request to HttPlaceholder should be appended to the string that will be send to the reverse proxy URL.
        /// </summary>
        [YamlMember(Alias = "appendQueryString")]
        [JsonProperty("appendQueryString")]
        public bool? AppendQueryString { get; set; }

        /// <summary>
        /// Gets or sets whether the path string of the request to HttPlaceholder should be appended to the string that will be send to the reverse proxy URL.
        /// </summary>
