...
public interface IStubSource
{
    ...
    /// </summary>
    /// <param name="user">The user the stubs should be retrieved for. Leave it null if there is no user.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>A list of <see cref="StubModel" />.</returns>
    Task<IEnumerable<StubModel>> GetStubsAsync(string user = null, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<StubOverviewModel>> GetStubsOverviewAsync(string user = null, CancellationToken cancellationToken = default);

    /// <summary>
    ///     Gets a <see cref="StubModel" /> by ID.
    /// </summary>
    /// <param name="stubId">The stub ID.</param>
    /// <param name="user">The user the stub should be retrieved for. Leave it null if there is no user.</param>
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>A <see cref="StubModel" />.</returns>
    Task<StubModel> GetStubAsync(string stubId, string user = null, CancellationToken cancellationToken = default);
