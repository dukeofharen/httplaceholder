...
/// <summary>
///     Describes a response writer that is used to populate the <see cref="ResponseModel" /> which is used for generating
///     a response.
/// </summary>
public interface IResponseWriter
{
    ...
    /// <returns>
    ///     A <see cref="StubResponseWriterResultModel" /> which contains data about the execution of this response
    ///     writer.
    /// </returns>
