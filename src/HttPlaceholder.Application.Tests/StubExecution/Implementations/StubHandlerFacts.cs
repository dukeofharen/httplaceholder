...
[TestClass]
public class StubHandlerFacts
{
    private readonly AutoMocker _mocker = new();
    private readonly MockLogger<StubHandler> _mockLogger = new();
    ...
    {
        _mocker.Use<ILogger<StubHandler>>(_mockLogger);
    ...
    [TestMethod]
    public async Task HandleStubRequestAsync_ExecuteStub_HappyFlow_AbortConnection()
    {
        // Arrange
        var handler = _mocker.CreateInstance<StubHandler>();
        var httpContextServiceMock = _mocker.GetMock<IHttpContextService>();
    ...
    [TestMethod]
    public async Task HandleStubRequestAsync_ExecuteStub_HappyFlow_NoRequestBody_ShouldNotWriteRequestBody()
    {
        // Arrange
        var handler = _mocker.CreateInstance<StubHandler>();
        var httpContextServiceMock = _mocker.GetMock<IHttpContextService>();
    ...
    [TestMethod]
    public async Task HandleStubRequestAsync_ExecuteStub_HappyFlow_RequestLoggingEnabled_ShouldLogRequest()
    {
        // Arrange
    ...
    [TestMethod]
    public async Task
        HandleStubRequestAsync_ExecuteStub_UiEnabled_RequestValidationExceptionWhenExecutingStub_ShouldReturn501WithHtmlPage()
    {
        // Arrange
        _settings.Storage.EnableRequestLogging = true;
    ...
    [TestMethod]
    public async Task
        HandleStubRequestAsync_ExecuteStub_UiEnabled_TaskCanceledExceptionWhenExecutingStub_ShouldReturn501WithHtmlPage()
    {
        // Arrange
        _settings.Storage.EnableRequestLogging = true;
        _settings.Gui.EnableUserInterface = true;
    ...
    [TestMethod]
    public async Task
        HandleStubRequestAsync_ExecuteStub_UiDisabled_RequestValidationExceptionWhenExecutingStub_ShouldReturn501WithoutHtmlPage()
    {
        // Arrange
        _settings.Storage.EnableRequestLogging = true;
    ...
    [TestMethod]
    public async Task HandleStubRequestAsync_ExecuteStub_AnotherExceptionWhileExecutingStub_ShouldReturn500()
    {
        // Arrange
        _settings.Storage.EnableRequestLogging = true;
        var handler = _mocker.CreateInstance<StubHandler>();
