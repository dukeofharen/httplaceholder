...
[TestClass]
public class GetRequestsOverviewQueryHandlerFacts
{
    ...
    {
        // Arrange
        var request = new GetRequestsOverviewQuery(null, null);
        var handler = _mocker.CreateInstance<GetRequestsOverviewQueryHandler>();
    ...
    {
        // Arrange
        var request = new GetRequestsOverviewQuery("abc123", null);
        var handler = _mocker.CreateInstance<GetRequestsOverviewQueryHandler>();
    ...
    {
        // Arrange
        var request = new GetRequestsOverviewQuery("abc123", 2);
        var handler = _mocker.CreateInstance<GetRequestsOverviewQueryHandler>();
