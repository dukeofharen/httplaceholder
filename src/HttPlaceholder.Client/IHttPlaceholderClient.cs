...
public interface IHttPlaceholderClient
{
    ...
    Task<FullStubDto> CreateStubForRequestAsync(string correlationId, CreateStubForRequestInputDto input = null, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<FullStubDto>> CreateStubsAsync(IEnumerable<StubDto> stubs, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The created stubs.</returns>
    Task<IEnumerable<FullStubDto>> CreateStubsAsync(IEnumerable<StubBuilder> stubs, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The requests.</returns>
    Task<IEnumerable<RequestResultDto>> GetRequestsByStubIdAsync(string stubId, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    Task UpdateAllStubsByTenantAsync(string tenant, IEnumerable<StubDto> stubs, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    Task UpdateAllStubsByTenantAsync(string tenant, IEnumerable<StubBuilder> stubBuilders, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The created stubs.</returns>
    Task<IEnumerable<FullStubDto>> CreateCurlStubsAsync(string input, bool doNotCreateStub, string tenant = "", CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The created stubs.</returns>
    Task<IEnumerable<FullStubDto>> CreateHarStubsAsync(string input, bool doNotCreateStub, string tenant = "", CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The created stubs.</returns>
    Task<IEnumerable<FullStubDto>> CreateOpenApiStubsAsync(string input, bool doNotCreateStub, string tenant = "", CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The <see cref="VerificationResultModel"/>.</returns>
    Task<VerificationResultModel> VerifyStubCalledAsync(string stubId, TimesModel times, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The <see cref="VerificationResultModel"/>.</returns>
    Task<VerificationResultModel> VerifyStubCalledAsync(string stubId, TimesModel times, DateTime minimumRequestTime, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">The cancellation token.</param>
    /// <returns>The <see cref="VerificationResultModel"/>.</returns>
    Task<VerificationResultModel> VerifyStubCalledAsync(string stubId, DateTime minimumRequestTime, CancellationToken cancellationToken = default);
}
