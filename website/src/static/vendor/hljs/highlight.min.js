...
;hljs.registerLanguage("csharp",e)})();/*! `javascript` grammar compiled for Highlight.js 11.8.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("javascript",e)})();/*! `yaml` grammar compiled for Highlight.js 11.8.0 */
