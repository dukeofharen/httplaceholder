...
<template>
  <div class="relative">
    ...
    <input
      ...
      @input="onInputChange"
      @keyup.esc="clear"
      class="w-full rounded-md border border-gray-500 py-2.5 ps-2.5 pe-10 shadow-sm sm:text-sm dark:border-gray-500 dark:bg-gray-800 dark:text-white placeholder-color-gray-500"
    />
