export const translations = {
  ...
  request: {
    ...
    createRequestStubTitle: 'Create a stub based on the request parameters of this request',
  ...
  stubForm: {
    ...
    priorityTitle: 'Set a stub priority (the higher the number, the higher the stub priority)',
    ...
    clientIpTitle: "Client IP (e.g. '127.0.0.1' or '127.0.0.0/30' to provide an IP range)",
    ...
    exactHitsTitle: 'Exact amount of hits that any stub under the same scenario should be hit',
    ...
    selectVariableHandler: 'Select a variable handler to insert in the response...',
    filterHandlers: 'Filter handlers...',
    filterExamples: 'Filter examples...',
    selectVariableHandlerExample: 'Select an example to insert in the response...',
  ...
  stringChecking: {
    ...
    doesnotstartwithciDescription: 'same as keyword above, but case insensitive',
    endswith: 'Ends with',
    endswithciDescription: 'checks if the input ends with this string, case sensitive',
    endswithci: 'Ends with case insensitive',
    endswithDescription: 'same as keyword above, but case insensitive',
    doesnotendwith: 'Does not end with',
    doesnotendwithDescription: 'checks if the input does not end with this string, case sensitive',
    ...
    regexnomatchesDescription: 'checks if the input does not match this regular expression',
    minlength: 'Minimum length',
    minLengthDescription: 'checks if the input has a minimum (inclusive) string length',
    maxlength: 'Maximum length',
    maxlengthDescription: 'checks if the input has a maximum (inclusive) string length',
  ...
  stubs: {
    ...
    disableStubsModalBody: 'Only the stubs currently visible in the list will be disabled.',
    ...
    enableStubsModalBody: 'Only the stubs currently visible in the list will be enabled.',
