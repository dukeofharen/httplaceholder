...
<template>
  <v-row v-shortkey="['ctrl', 's']" @shortkey="saveStub">
    <v-col>
      ...
      <v-card class="ma-5">
        <v-card-title v-if="!routeStubId"
          >You can add a new stub here</v-card-title
        >
        <v-card-title v-if="routeStubId"
          >You can update the stub here</v-card-title
        >
        <v-card-text>
          <v-row>
            <v-col>
              Use the form below to specify the request conditions and which
              response should be returned when the request conditions all match.
            </v-col>
          </v-row>
        </v-card-text>
      </v-card>
            ...
            <v-col>
              ...
              <div class="d-flex flex-row mb-6">
                ...
                <v-menu absolute offset-y>
                  ...
                  <v-list>
                    <v-list-item
                      v-for="(tenant, index) in filteredTenantNames"
                      :key="index"
        ...
        <v-card-text>
          <v-row>
            <v-col>
              <div>
                <p>
                  Define what the request should look like before the response
              ...
              <div>
                <h2
                  class="section-title"
                  @click="show.generalConditions = !show.generalConditions"
                >
                  <v-icon>{{
                    show.generalConditions
                      ? "mdi-chevron-down"
                      : "mdi-chevron-right"
                  }}</v-icon>
                  General conditions
              ...
              <div v-if="show.generalConditions">
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-menu absolute offset-y>
                    <template v-slot:activator="{ on }">
                      <v-text-field
                        v-model="stubConditionMethod"
                        :label="formLabels.httpMethod"
                        v-on="on"
                        clearable
                        class="pa-2"
                      />
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-text-field
                    v-model="stubConditionClientIp"
                    :label="formLabels.clientIp"
                    class="pa-2"
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-text-field
                    v-model="stubConditionHost"
                    :label="formLabels.hostname"
                    class="pa-2"
              ...
              <div>
                <h2
                  class="section-title"
                  @click="show.urlConditions = !show.urlConditions"
                >
                  <v-icon>{{
                    show.urlConditions
                      ? "mdi-chevron-down"
              ...
              <div v-if="show.urlConditions">
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-text-field
                    v-model="stubConditionUrlPath"
                    :label="formLabels.urlPath"
                    class="pa-2"
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-textarea
                    v-model="stubQueryStrings"
                    :label="formLabels.queryString"
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-text-field
                    v-model="stubConditionUrlFullPath"
                    :label="formLabels.fullPath"
                    class="pa-2"
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-radio-group v-model="stubIsHttp" class="pa-2">
                    <v-radio
                      :value="isHttpsValues.onlyHttps"
                      :label="formLabels.onlyHttps"
                    ></v-radio>
                    <v-radio
                      :value="isHttpsValues.onlyHttp"
                      :label="formLabels.onlyHttp"
                    ></v-radio>
                    <v-radio
                      :value="isHttpsValues.httpAndHttps"
                      :label="formLabels.httpAndHttps"
                    ></v-radio>
                  </v-radio-group>
                </div>
              </div>
              ...
              <div>
                <h2
                  class="section-title"
                  @click="show.headerConditions = !show.headerConditions"
                >
                  <v-icon>{{
                    show.headerConditions
                      ? "mdi-chevron-down"
                      : "mdi-chevron-right"
                  }}</v-icon>
                  Header conditions
              ...
              <div v-if="showBodyConditionForms">
                <h2
                  class="section-title"
                  @click="show.bodyConditions = !show.bodyConditions"
                >
                  <v-icon>{{
                    show.bodyConditions
                      ? "mdi-chevron-down"
              ...
              <div v-if="showBodyConditionForms">
                <h2
                  class="section-title"
                  @click="show.formBodyConditions = !show.formBodyConditions"
                >
                  <v-icon>{{
                    show.formBodyConditions
                      ? "mdi-chevron-down"
                      : "mdi-chevron-right"
                  }}</v-icon>
              ...
              <div v-if="show.formBodyConditions">
                ...
                <div class="d-flex flex-row mb-6" v-if="showBodyConditionForms">
                  ...
                  <v-textarea
                    v-model="stubFormBody"
                    :label="formLabels.formBody"
              ...
              <div v-if="showBodyConditionForms">
                <h2
                  class="section-title"
                  @click="show.xmlBodyConditions = !show.xmlBodyConditions"
                >
                  <v-icon>{{
                    show.xmlBodyConditions
                      ? "mdi-chevron-down"
                      : "mdi-chevron-right"
                  }}</v-icon>
                  XML body conditions
              ...
              <div v-if="show.xmlBodyConditions">
                ...
                <div class="d-flex flex-row mb-6" v-if="showBodyConditionForms">
                  ...
                  <v-textarea
                    v-model="stubXPathNamespaces"
                    :label="formLabels.xpathNamespaces"
              ...
              <div v-if="showBodyConditionForms">
                <h2
                  class="section-title"
                  @click="show.jsonBodyConditions = !show.jsonBodyConditions"
                >
                  <v-icon>{{
                    show.jsonBodyConditions
                      ? "mdi-chevron-down"
                      : "mdi-chevron-right"
                  }}</v-icon>
              ...
              <div v-if="show.jsonBodyConditions">
                ...
                <div class="d-flex flex-row mb-6" v-if="showBodyConditionForms">
                  ...
                  <v-textarea
                    v-model="stubJsonPath"
                    :label="formLabels.jsonPath"
              ...
              <div>
                <h2
                  class="section-title"
                  @click="
                    show.authenticationConditions = !show.authenticationConditions
                  "
                >
                  <v-icon>{{
                    show.authenticationConditions
                      ? "mdi-chevron-down"
                      : "mdi-chevron-right"
                  }}</v-icon>
              ...
              <div v-if="show.authenticationConditions">
                ...
                <div class="d-flex flex-row mb-6">
                  <FormTooltip tooltipKey="fullPath" />
                  <v-text-field
                    v-model="stubConditionBasicAuthUsername"
                    :label="formLabels.basicAuthUsername"
                    class="pa-2"
                  />
                  <v-text-field
                    v-model="stubConditionBasicAuthPassword"
                    :label="formLabels.basicAuthPassword"
                    class="pa-2"
                  />
                </div>
              </div>
        ...
        <v-card-text>
          <v-row>
            <v-col>
              <div>
                <p>
                  Define what the response should look like that will be
              ...
              <div>
                <h2
                  class="section-title"
                  @click="show.generalWriters = !show.generalWriters"
                >
                  <v-icon>{{
                    show.generalWriters
                      ? "mdi-chevron-down"
              ...
              <div v-if="show.generalWriters">
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-menu absolute offset-y>
                    <template v-slot:activator="{ on }">
                      <v-text-field
                        v-model="stubResponseStatusCode"
                        :label="formLabels.statusCode"
                        v-on="on"
                        clearable
                        class="pa-2"
                      />
                    ...
                    <v-list max-height="300px">
                      <v-list-item
                        v-for="code in formattedStatusCodes"
                        :key="code.code"
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-text-field
                    v-model="stubResponseExtraDuration"
                    :label="formLabels.extraDuration"
                    class="pa-2"
                  />
                </div>
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-switch
                    v-model="stubResponseDynamicMode"
                    :label="formLabels.enableDynamicMode"
                    class="pa-2"
                  />
                </div>
              </div>
              ...
              <div>
                <h2
                  class="section-title"
                  @click="show.bodyWriters = !show.bodyWriters"
                >
                  <v-icon>{{
                    show.bodyWriters ? "mdi-chevron-down" : "mdi-chevron-right"
                  }}</v-icon>
                  Body writers
                </h2>
              </div>
              ...
              <div v-if="show.bodyWriters">
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-select
                    v-model="stubBodyResponseType"
                    :items="responseBodyTypes"
                    item-text="value"
                    item-value="value"
                ...
                <div class="d-flex flex-row mb-6" v-if="showResponseBodyForm">
                  ...
                  <v-textarea
                    v-model="stubResponseBody"
                    :label="formLabels.responseBody"
                ...
                <div
                  ...
                  v-if="showResponseBodyForm && showFileUpload"
                >
                  <FormTooltip tooltipKey="base64Upload" />
                  <v-btn color="success" @click="selectFile" class="ma-5"
                    >Select file</v-btn
                  >
                  <input
                    type="file"
                ...
                >
                  ...
                  <v-menu absolute offset-y>
                    <template v-slot:activator="{ on }">
                      <v-btn color="success" v-on="on" class="ma-5"
                        >Select variable handler</v-btn
                      >
                    </template>
                    <v-list max-height="300px">
                      <v-list-item
                        v-for="handler in variableHandlers"
                        :key="handler.name"
                        @click="insertHandlerInBody(handler)"
                      >
                        <v-list-item-title
                          >{{ handler.name }}: {{ handler.fullName }}. Example:
                          {{ handler.example }}
                        </v-list-item-title>
                      </v-list-item>
                    </v-list>
              ...
              <div>
                <h2
                  class="section-title"
                  @click="show.headerWriters = !show.headerWriters"
                >
                  <v-icon>{{
                    show.headerWriters
                      ? "mdi-chevron-down"
              ...
              <div v-if="show.headerWriters">
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-textarea
                    v-model="stubResponseHeaders"
                    :label="formLabels.responseHeaders"
              ...
              <div>
                <h2
                  class="section-title"
                  @click="show.redirectWriters = !show.redirectWriters"
                >
                  <v-icon>{{
                    show.redirectWriters
                      ? "mdi-chevron-down"
                      : "mdi-chevron-right"
                  }}</v-icon>
                  Redirection writers
              ...
              <div v-if="show.redirectWriters">
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-text-field
                    v-model="stubResponseTempRedirect"
                    :label="formLabels.temporaryRedirect"
                    class="pa-2"
                ...
                <div class="d-flex flex-row mb-6">
                  <FormTooltip tooltipKey="redirect" />
                  <v-text-field
                    v-model="stubResponsePermanentRedirect"
                    :label="formLabels.permanentRedirect"
                    class="pa-2"
                    :placeholder="formPlaceholderResources.redirect"
                  />
                </div>
              ...
              <div>
                <h2
                  class="section-title"
                  @click="show.reverseProxy = !show.reverseProxy"
                >
                  <v-icon>{{
                    show.reverseProxy ? "mdi-chevron-down" : "mdi-chevron-right"
                  }}</v-icon>
              ...
              <div v-if="show.reverseProxy">
                <div>
                  <p>
                    The reverse proxy functionality is useful for if you want
                    some (or all) requests to be sent to an external web
                    service.
                  </p>
                </div>
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-text-field
                    v-model="stubResponseReverseProxyUrl"
                    :label="formLabels.reverseProxyUrl"
                    class="pa-2"
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-switch
                    v-model="stubResponseReverseProxyAppendQueryString"
                    :label="formLabels.appendQueryString"
                    class="pa-2"
                  />
                </div>
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-switch
                    v-model="stubResponseReverseProxyAppendPath"
                    :label="formLabels.appendPath"
                    class="pa-2"
                  />
                </div>
                ...
                <div class="d-flex flex-row mb-6">
                  ...
                  <v-switch
                    v-model="stubResponseReverseProxyReplaceRootUrl"
                    :label="formLabels.replaceRootUrl"
                    class="pa-2"
                  />
                </div>
              </div>
            ...
            <v-col>
              <div>
                <h2 class="section-title" @click="show.yaml = !show.yaml">
                  <v-icon>{{
                    show.yaml ? "mdi-chevron-down" : "mdi-chevron-right"
                  }}</v-icon>
                  Stub as YAML
                </h2>
              </div>
              ...
              <div v-if="show.yaml">
                <p>
                  Here you can see the stub as YAML for use on your PC for
                  example.
                </p>
...
export default {
  ...
  async mounted() {
    this.tenantNames = await this.$store.dispatch(actionNames.getTenantNames);
  ...
  computed: {
    ...
    ...mapFields({
      ...
      stubConditionBasicAuthUsername:
        "stubForm.stub.conditions.basicAuthentication.username",
      stubConditionBasicAuthPassword:
        "stubForm.stub.conditions.basicAuthentication.password",
      ...
      stubResponseReverseProxyAppendQueryString:
        "stubForm.stub.response.reverseProxy.appendQueryString",
      stubResponseReverseProxyAppendPath:
        "stubForm.stub.response.reverseProxy.appendPath",
      stubResponseReverseProxyReplaceRootUrl:
        "stubForm.stub.response.reverseProxy.replaceRootUrl"
    })
  },
  methods: {
    async initialize() {
    ...
    async saveStub() {
      ...
      if (this.routeStubId) {
        try {
          ...
          toastSuccess(
            resources.stubUpdatedSuccessfully.format(this.routeStubId)
          );
        } catch (e) {
          if (e.response) {
    ...
    insertHandlerInBody(handler) {
      this.stubResponseBody = this.insertHandler(
        handler,
        this.stubResponseBody || "",
        "response-body"
      );
    },
    insertHandlerInHeaders(handler) {
      this.stubResponseHeaders = this.insertHandler(
        handler,
    ...
    loadTextFromFile(ev) {
      ...
      reader.onload = e => {
        ...
        if (regexMatches.length > 1) {
          ...
          this.$store.commit(mutationNames.setResponseHeader, {
            key: "Content-Type",
            value: mime
          });
        }
