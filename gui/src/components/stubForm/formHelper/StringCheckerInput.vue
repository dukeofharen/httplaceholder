  ...
  <div class="row" @keyup.enter="insert">
    <div class="col-md-12">
      ...
      <div v-for="(item, index) of formData" :key="index" class="row mt-2">
        ...
        <div class="col-md-3">
          <select class="form-select" v-model="formData[index].stringCheckingKeyword">
            <option
        ...
        <div class="col-md-3">
          <input type="text" class="form-control" v-model="formData[index].value" />
        </div>
...
import { getStringCheckingKeywords, keywords } from '@/domain/string-checking-keywords'
        ...
        if (props.hasMultipleKeys) {
          ...
          for (const key of keys) {
            ...
            for (const stringCheckingKey of stringCheckingKeys) {
              const stringCheckingValue = stringCheckingValues[stringCheckingKey]
              formData.value.push({
